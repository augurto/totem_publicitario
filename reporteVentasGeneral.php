                                ...
                                <div class="col-lg-4">
                                    <div class="card border border-success">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">fechaVenta: <?php echo $nuevaFecha; ?></p>
...
<script>
    ...
    chartSpark3 = new ApexCharts(document.querySelector("#order_charts"), optionsSpark3);
    chartSpark3.render();
    ...
    chart = new ApexCharts(document.querySelector("#spline_area_month"), options);
    chart.render();
    ...
    options = {
        chart: {
            ...
            chart = new ApexCharts(document.querySelector("#spline_area_year"), options);
            chart.render();
            options = {
            chart: {
                height: 223,
        ...
        chart = new ApexCharts(document.querySelector("#column_chart_datalabel"), options);
        chart.render();
        ...
        options = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: {
                        showOn: "always",
                        total: { show: true, label: "Total", formatter: function (e) { return 73.7; } },
                        name: { show: true, color: "#000", fontSize: "15px" },
        ...
        chart = new ApexCharts(document.querySelector("#target_charts"), options);
        chart.render();
