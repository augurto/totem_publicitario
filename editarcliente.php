                                ...
                                <form id="myForm" action="includes/guardar_user.php" method="post">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            $query4 = "SELECT idWeb, documentoCliente FROM cliente WHERE idWeb = $idUrl ORDER BY idCliente DESC LIMIT 1  ";
                                        ...
                                        ?>
                                            ...
                                            <br>
                                            <?php if ($documento === null || empty($documentoCliente)):  echo $documentoCliente
;?>
                                                <center>
