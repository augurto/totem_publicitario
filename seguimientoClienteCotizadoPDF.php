...
$pdf->Cell(60, 20, '', 1, 0, '', 1); // Primera columna para la imagen
$pdf->Cell(60, 20, 'Texto 1', 1, 0, 'C', 1); // Segunda columna para el texto 1
$pdf->Cell(60, 20, 'Texto 2', 1, 1, 'C', 1); // Tercera columna para el texto 2
$pdf->Ln(10);
