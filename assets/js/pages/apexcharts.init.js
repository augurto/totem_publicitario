...
options = {
  ...
  series: [
    { name: "series1.8", data: [34, 40, 28, 52, 42, 109, 100] },
    { name: "series2.2", data: [32, 60, 34, 46, 34, 52, 41] },
  ],
  colors: ["#5867c3", "#34c38f"],
  xaxis: {
    type: "datetime",
...
// Supongamos que jsonData contiene los datos obtenidos de la base de datos en formato JSON
...
var options = {
  ...
  xaxis: {
    categories: jsonData.map(item => item.mes_anio), // Utiliza los meses y años como etiquetas
  },
  yaxis: { title: { text: "$ (thousands2)" } },
